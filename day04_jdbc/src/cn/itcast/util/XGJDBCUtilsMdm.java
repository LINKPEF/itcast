...
public class XGJDBCUtilsMdm {
    ...
    static {
        ...
        try {
            ...
            //2.加载文件
            /*java.io.FileNotFoundException: src\mcm.properties (系统找不到指定的路径。)
            原因是我们写的是相对路径，应该写个绝对路径，但是写绝对路径我们修改路径后这里也需要更改*/
            //pro.load(new FileReader("src/mcm.properties"));
           ...
           URL res=classLoader.getResource("mcm.properties");
            ...
            ClassLoader classLoader = XGJDBCUtilsMdm.class.getClassLoader();
            URL res  = classLoader.getResource("xuguMDM.properties");
